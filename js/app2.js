...
let logueadoStatus = localStorage.getItem("Log") || false;
...
// Funciones Perfil y login

const verificarLoginNav = (logueado) => {
  if(!logueado){
    navLogin.innerHTML = " "
    navLogin.innerHTML = ` 
    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                ...
                <ul class="dropdown-menu bg-dark text-center">
                  <li>
                    <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#loginModal" href="#">Iniciar Sesion</a>
                  </li>
                  <li>
                    <hr class="dropdown-divider" />
                  </li>
                  <li>
                    <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#registerModal" href="#">Registrarse</a>
                  </li> 
...
verificarLoginNav(logueadoStatus);
verCarritoNotificacion();
verCarrito(carritoCompra);